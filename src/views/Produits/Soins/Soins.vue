            ...
            <v-col cols="4">
                <v-card hover width="200" style="position: fixed;">
                    ...
                    <v-radio-group v-model="filtre">
                        <v-radio color="#16b377" label="Prix" value="prix" @click="`one`" Checked></v-radio>
                        <v-radio color="#16b377" label="Note" value="note" @click="`two`"></v-radio>
                    </v-radio-group>
                </v-card>
            </v-col>
            <v-col cols="7">
                ...
                <div class="display-articles" v-for="(soin, i) in allSoins" :key="i">
                    ...
                    <v-card hover width="500">
                        ...
                        <span class="d-flex justify-space-around align-center" :title="soin.descriptionCourte">
                            ...
                            <span class="d-flex flex-column">
                                ...
                                <span class="d-flex">
                                    ...
                                    <span>
                                        <CustomInput title="Quantité" class="ml-5" v-model="quantite" :max="soin.stock" />
                                    </span>
                        ...
                        <span class="d-flex align-self-end mb-2">
                            <v-rating readonly :length="5" :size="20" v-model="soin.note" color="yellow accent-4" dense
